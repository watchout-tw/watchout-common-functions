...
export function getPersona() {
  return customGet(false, `/persona`)
}
...
export function getAuthor(id) {
  return customGet(false, `/personas/author/${id}`)
}
...
export function deleteAuthor(personaID, roleID) {
  return coreInstance.delete(`/persona/${personaID}/role/${roleID}`)
}

export function postCivilguideEmail(email) {
  return coreInstance.post('/project/civilguide/active/email', { email })
}
